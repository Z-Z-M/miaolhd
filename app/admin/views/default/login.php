...
if ($this->auth->CI->manager_session->flashdata('message')) {
	$message = $this->auth->CI->manager_session->flashdata('message');
}
...
?>
		<!--表单开始-->
		<?php $attributes = array('class' => 'form-horizontal', 'name' => 'login_form');
...
?>
	...
	<?php endif;?>
		...
		<div class="alert alert-error">
			<a class="close" data-dismiss="alert"i d="error_alert">×</a>
			<?php echo $error;?>
		</div>
	<?php endif;?>
...
<!--底部开始-->
		<footer>
			...
			<p class="pull-right"><?php echo lang('writer');?>：<a href="#" target="_blank">妙连互动</a></p>
		</footer>
<!--/.底部结束-->
<!--script开始-->
